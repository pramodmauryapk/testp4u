...
public class SetprofileimageFragment extends HomeFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        Button button 	= (Button)v. findViewById(R.id.btn_crop);
        mImageView		= (ImageView)v. findViewById(R.id.iv_photo);
